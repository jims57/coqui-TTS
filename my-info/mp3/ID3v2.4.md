...
Prepend the tag.
Prepend a tag with all vital information and add a second tag at the end of the file, before tags from other tagging systems. The first tag is required to have a SEEK frame.
Add a tag at the end of the file, before tags from other tagging systems.
...
Look for a prepended tag using the pattern found in section 3.1.
If a SEEK frame was found, use its values to guide further searching.
Look for a tag footer, scanning from the back of the file.
