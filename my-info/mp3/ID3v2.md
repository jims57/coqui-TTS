...
TRC
The ‘ISRC’ frame should contian the International Standard Recording Code [ISRC].
TYE
...
$01 is lyrics $02 is text transcription $03 is movement/part name (e.g. “Adagio”) $04 is events (e.g. “Don Quijote enters the stage”) $05 is chord (e.g. “Bb F Fsus”)
...
above). Revision to this field has been made in ID3v1.1. See A.4.
Genre: this byte contains the offset of a genre in a predefined
list the byte is treated as an unsigned byte. The offset is starting from 0. See A.3.
Genre List
